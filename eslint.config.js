...
export default tseslint.config(
  ...
  { files: ["scripts/**/*.mjs", "src/worker/**/*.{mjs,ts}"], languageOptions: { globals: { ...globals.node, WebSocket: "readonly" } } },
  {
    files: ["src/**/*.{ts,tsx}"], languageOptions: { ecmaVersion: 2022, globals: globals.browser },
