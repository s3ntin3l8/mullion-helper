...
import type { AgentCandidate, BridgeStatus, Settings, UpdateResult } from "./types";
...
export const api = {
  ...
  listAgentSockets: () => inTauri ? invoke<AgentCandidate[]>("list_agent_sockets") : Promise.resolve([]),
